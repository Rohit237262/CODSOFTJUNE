...
if __name__ == "__main__":
    ...
    guiWindow.title("To-Do List  - NEERAJ RAJAN")
    # setting the geometry of the window
    guiWindow.geometry("400x350+650+250")
    ...
    header_frame = tk.Frame(guiWindow, bg="#D2B48C")
    functions_frame = tk.Frame(guiWindow, bg="#D2B48C")
    listbox_frame = tk.Frame(guiWindow, bg="#D2B48C")
    ...
    del_button.place(x=30, y=155)
    del_all_button.place(x=30, y=186)
